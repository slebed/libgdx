...
public class VulkanTestStarter {
    ...
    static class VulkanTestChooser extends ApplicationAdapter {
        ...
        private VulkanScrollPane scroll;
        ...
        public void create() {
            ...
            scroll = new VulkanScrollPane(tableTests, skin);
            ...
            container.add(tableTests).expand().fill();
        ...
        public void render() {
            ...
            if (scroll != null && scroll.getActor() != null) {
                System.out.println("LOG (Between act/draw): ScrollPane child Y = " + scroll.getActor().getY());
            }
        }
