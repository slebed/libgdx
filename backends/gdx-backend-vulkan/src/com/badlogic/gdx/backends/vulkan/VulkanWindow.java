...
public class VulkanWindow implements Disposable {
    ...
    VulkanWindow(ApplicationListener listener, Array<LifecycleListener> lifecycleListeners, VulkanApplicationConfiguration config, VulkanApplicationBase application) {
