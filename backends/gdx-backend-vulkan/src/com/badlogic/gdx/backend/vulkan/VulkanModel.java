...
public class VulkanModel implements Disposable {
	...
	/** Materials used by this model. Ownership/disposal depends: if loaded uniquely for this model, model disposes. If shared from
	 * an AssetManager, AssetManager disposes. For now, let's assume if added here, this model has a responsibility towards them,
	...
	/** Creates a VulkanModel. The caller is responsible for populating the meshes, materials, and meshParts arrays. This is
	 * typically done by a model loader.
	...
	/** Disposes all {@link VulkanMesh} objects this model owns. Materials are typically data containers and might not own heavy
	 * resources themselves (textures they reference are usually managed externally). */
	@Override
	public void dispose () {
