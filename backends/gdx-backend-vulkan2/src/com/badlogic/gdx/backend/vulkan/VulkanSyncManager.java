...
/**
 * Manages Vulkan synchronization primitives (Semaphores, Fences)
 * required for controlling the frame rendering loop.
 * (Initial version supports 1 frame in flight).
 */
public class VulkanSyncManager implements Disposable {
    ...
    private void createSyncObjectsInternal() {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            Gdx.app.log(logTag, "Sync objects created: ImgAvail=" + imageAvailableSemaphore
                    + ", RenderFin=" + renderFinishedSemaphore + ", Fence=" + inFlightFence);
