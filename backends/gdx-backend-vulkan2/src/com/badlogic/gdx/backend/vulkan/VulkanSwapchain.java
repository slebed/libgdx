...
public class VulkanSwapchain implements Disposable {
	...
	public long getHandle() { return swapchain; }
	...
	public int getImageCount() { return swapchainImages != null ? swapchainImages.size() : 0; }
	...
	public void clearRecreationFlag() { this.needsRecreation = false; }
