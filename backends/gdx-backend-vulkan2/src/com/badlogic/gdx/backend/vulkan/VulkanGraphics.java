...
public class VulkanGraphics extends AbstractGraphics implements Disposable {
	...
	public VulkanGraphics (long primaryWindowHandle, VulkanApplicationConfiguration config, VulkanDevice device,
	...
	public boolean setWindowedMode (int width, int height) {
		...
		if (!isFullscreen()) {
			...
			if (width != windowWidthBeforeFullscreen || height != windowHeightBeforeFullscreen) {
				...
				GridPoint2 newPos = VulkanApplicationConfiguration.calculateCenteredWindowPosition((VulkanMonitor)monitor, width,
					height);
				posX = newPos.x;
				posY = newPos.y;
			} else {
