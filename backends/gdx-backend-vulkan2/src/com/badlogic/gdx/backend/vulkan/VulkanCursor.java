...
public class VulkanCursor implements Cursor {
	static final Array<VulkanCursor> cursors = new Array<VulkanCursor>();
	...
	static void dispose (VulkanWindow window) {
		for (int i = cursors.size - 1; i >= 0; i--) {
			VulkanCursor cursor = cursors.get(i);
