...
public class VkResultDecoder {
    ...
    public static String decode(int vkResultCode) {
        switch (vkResultCode) {
            ...
            case VK_SUBOPTIMAL_KHR: return "VK_SUBOPTIMAL_KHR"; // Swapchain related
            ...
            case VK_ERROR_OUT_OF_DATE_KHR: return "VK_ERROR_OUT_OF_DATE_KHR"; // Swapchain related
            case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR: return "VK_ERROR_INCOMPATIBLE_DISPLAY_KHR";

            // --- VK11 Errors (Example) ---
            case VK_ERROR_OUT_OF_POOL_MEMORY: return "VK_ERROR_OUT_OF_POOL_MEMORY"; // Renamed from _KHR
            case VK_ERROR_INVALID_EXTERNAL_HANDLE: return "VK_ERROR_INVALID_EXTERNAL_HANDLE"; // Renamed from _KHR

            // --- Debug/Validation Errors ---
            case VK_ERROR_VALIDATION_FAILED_EXT: return "VK_ERROR_VALIDATION_FAILED_EXT"; // Common with validation layers
