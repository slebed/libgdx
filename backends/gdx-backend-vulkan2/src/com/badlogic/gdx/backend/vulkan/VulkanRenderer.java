...
/**
 * A simple helper class to encapsulate common Vulkan rendering command sequences.
 * Takes an active command buffer and provides methods to bind state and issue draws.
 * Note: This initial version is very basic and assumes simple state management.
 */
    ...
    public void setDynamicStates(VkExtent2D extent) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            VkRect2D.Buffer scissor = VkRect2D.calloc(1, stack)
                    .offset(o -> o.set(0, 0))
                    .extent(extent); // Use extent directly
    ...
    public void bindDescriptorSet(long layoutHandle, long setHandle, int setIndex) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            vkCmdBindDescriptorSets(currentCommandBuffer,
                    ...
                    layoutHandle,
                    setIndex, // The set index (usually 0)
                    pDescriptorSets,
