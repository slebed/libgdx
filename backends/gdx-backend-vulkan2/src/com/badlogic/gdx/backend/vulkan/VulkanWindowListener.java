 ...
 * set per window via {@link VulkanApplicationConfiguration} and {@link VulkanWindowConfiguration}. Close events can be canceled
 * by returning false.
 * 
 * @author badlogic */
public interface VulkanWindowListener {

	/** Called after the GLFW window is created. Before this callback is received, it's unsafe to use any {@link VulkanWindow}
	 ...
	 * {@link VulkanApplication#VulkanApplication(ApplicationListener, VulkanApplicationConfiguration)}.
	 *
	 * @param window the window instance
	 *
	 * @see VulkanApplication#newWindow(ApplicationListener, VulkanWindowConfiguration) */
	void created (VulkanWindow window);
	 ...
	 * {@link VulkanGraphics#requestRendering()} is automatically called. */
