 ...
 * @author mzechner
 * @author Nathan Sweet */
public class VulkanScrollPane extends WidgetGroup implements Styleable<VulkanScrollPane.ScrollPaneStyle> {
    private com.badlogic.gdx.backend.vulkan.VulkanScrollPane.ScrollPaneStyle style;
    private Actor actor;
    ...
    public VulkanScrollPane(@Null Actor actor) {
        this(actor, new  com.badlogic.gdx.backend.vulkan.VulkanScrollPane.ScrollPaneStyle());
    }

    /** @param actor May be null. */
    public VulkanScrollPane(@Null Actor actor, Skin skin) {
        this(actor, skin.get( com.badlogic.gdx.backend.vulkan.VulkanScrollPane.ScrollPaneStyle.class));
    }

    /** @param actor May be null. */
    public VulkanScrollPane(@Null Actor actor, Skin skin, String styleName) {
        this(actor, skin.get(styleName,  com.badlogic.gdx.backend.vulkan.VulkanScrollPane.ScrollPaneStyle.class));
    }

    /** @param actor May be null. */
    public VulkanScrollPane(@Null Actor actor, com.badlogic.gdx.backend.vulkan.VulkanScrollPane.ScrollPaneStyle style) {
    ...
    protected void addCaptureListener() {
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (getStage() != null) getStage().setScrollFocus(com.badlogic.gdx.backend.vulkan.VulkanScrollPane.this);
        ...
        return new ActorGestureListener() {
            ...
            public void fling(InputEvent event, float x, float y, int button) {
                ...
                if (velocityX != 0 || velocityY != 0) {
                    ...
                    com.badlogic.gdx.backend.vulkan.VulkanScrollPane.this.fling(flingTime, velocityX, velocityY);
                }
            }
    ...
    public com.badlogic.gdx.backend.vulkan.VulkanScrollPane.ScrollPaneStyle getStyle() {
        return style;
    }
    ...
    public boolean clipBegin (float x, float y, float width, float height) {
        ...
        VulkanStage stage = (VulkanStage) getStage();//this.stage;
