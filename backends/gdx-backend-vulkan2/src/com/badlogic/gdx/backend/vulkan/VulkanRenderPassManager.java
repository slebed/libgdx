...
/**
 * Helper class to manage beginning and ending Vulkan render pass instances,
 * specifically tailored for the main swapchain render pass.
 */
public class VulkanRenderPassManager {
    ...
    /**
     * Begins the main swapchain render pass on the given command buffer.
     * Assumes the commandBuffer is already in the recording state.
     *
    ...
    public void beginSwapchainRenderPass(VkCommandBuffer commandBuffer, VulkanSwapchain swapchain, int imageIndex, Color clearColor) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            long framebufferHandle = swapchain.getFramebuffer(imageIndex); // getFramebuffer handles index check
