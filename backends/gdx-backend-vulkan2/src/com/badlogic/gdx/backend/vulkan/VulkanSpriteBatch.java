...
public class VulkanSpriteBatch implements Batch, Disposable {
	...
	public VulkanSpriteBatch (int size) {
		...
		Gdx.app.log(TAG, "Created vertexBuffer handle: " + this.vertexBuffer.bufferHandle + ", Allocation: "
			+ this.vertexBuffer.allocationHandle);
		...
		Gdx.app.log(TAG,
			"Created indexBuffer handle: " + this.indexBuffer.bufferHandle + ", Allocation: " + this.indexBuffer.allocationHandle);
		...
		Gdx.app.log(TAG, "Created projMatrixUbo handle: " + this.projMatrixUbo.bufferHandle + ", Allocation: "
			+ this.projMatrixUbo.allocationHandle);
	...
	public void dispose () {
		...
		if (descriptorManager != null && !batchDescriptorSets.isEmpty()) {
			Gdx.app.log(TAG,
				"Freeing " + batchDescriptorSets.size() + " descriptor sets via manager for batch hash: " + this.hashCode());
			try {
